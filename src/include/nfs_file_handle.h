...
int nfs4_FhandleToFSAL(nfs_fh4 * pfh4, struct fsal_obj_handle **pfsalhandle,
                       fsal_op_context_t * pcontext);
int nfs3_FhandleToFSAL(nfs_fh3 * pfh3, struct fsal_obj_handle **pfsalhandle,
                       fsal_op_context_t * pcontext);
int nfs2_FhandleToFSAL(fhandle2 * pfh2, struct fsal_obj_handle **pfsalhandle,
                       fsal_op_context_t * pcontext);

int nfs4_FSALToFhandle(nfs_fh4 * pfh4, struct fsal_obj_handle *pfsalhandle,
