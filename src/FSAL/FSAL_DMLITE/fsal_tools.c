...
int
DMLITEFSAL_handlecmp(fsal_handle_t *exthandle1,
                   fsal_handle_t *exthandle2,
                   fsal_status_t *status)
{
     dmlitefsal_handle_t *handle1 = (dmlitefsal_handle_t *)exthandle1;
     dmlitefsal_handle_t *handle2 = (dmlitefsal_handle_t *)exthandle2;
...
unsigned int
DMLITEFSAL_Handle_to_HashIndex(fsal_handle_t *exthandle,
                             unsigned int cookie,
...
unsigned int
DMLITEFSAL_Handle_to_RBTIndex(fsal_handle_t *exthandle,
                            unsigned int cookie)
{
     dmlitefsal_handle_t* handle = (dmlitefsal_handle_t *)exthandle;
...
fsal_status_t
DMLITEFSAL_DigestHandle(fsal_export_context_t *extexport,
...
fsal_status_t
DMLITEFSAL_ExpandHandle(fsal_export_context_t *extexport,
                      fsal_digesttype_t in_type,
                      struct fsal_handle_desc *fh_desc)
{
     dmlitefsal_handle_t* handle = (dmlitefsal_handle_t*) fh_desc->start;
     dmlitefsal_export_context_t* export = (dmlitefsal_export_context_t*)extexport;
     int rc = 0;
