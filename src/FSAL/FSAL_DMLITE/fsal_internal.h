...
//extern dmlitefs_specific_initinfo_t global_spec_info;
...
fsal_status_t DMLITEFSAL_access(fsal_handle_t * exthandle,
                              fsal_op_context * extcontext,
                              fsal_accessflags_t access_type,
                              fsal_attrib_list_t * object_attributes);

fsal_status_t DMLITEFSAL_getattrs(fsal_handle_t * exthandle,
                                fsal_op_context_t * extcontext,
                                fsal_attrib_list_t * object_attributes);

fsal_status_t DMLITEFSAL_setattrs(fsal_handle_t * exthandle,
                                fsal_op_context_t * extcontext,
                                fsal_attrib_list_t * attrib_set,
                                fsal_attrib_list_t * object_attributes);

fsal_status_t DMLITEFSAL_getextattrs(
...
fsal_status_t DMLITEFSAL_InitClientContext(
     fsal_op_context_t* extcontext);

fsal_status_t DMLITEFSAL_GetClientContext(
     fsal_op_context_t * extcontext,
     fsal_export_context_t * extexport_context,
     fsal_uid_t uid,
     fsal_gid_t gid,
...
fsal_status_t DMLITEFSAL_create(fsal_handle_t * extparent,
...
fsal_status_t DMLITEFSAL_mkdir(fsal_handle_t * extparent,
                             fsal_name_t * dirname,
                             fsal_op_context_t * extcontext,
                             fsal_accessmode_t accessmode,
                             fsal_handle_t * object_handle,
...
fsal_status_t DMLITEFSAL_link(fsal_handle_t * exttarget,
...
fsal_status_t DMLITEFSAL_mknode(fsal_handle_t * parent,
...
fsal_status_t DMLITEFSAL_open_by_fileid(fsal_handle_t * filehandle,
                                      fsal_u64_t fileid,
                                      fsal_op_context_t * p_context,
                                      fsal_openflags_t openflags,
...
fsal_status_t DMLITEFSAL_close_by_fileid(fsal_file_t * file_descriptor,
                                       fsal_u64_t fileid);
...
fsal_status_t DMLITEFSAL_static_fsinfo(fsal_handle_t * exthandle,
...
fsal_status_t DMLITEFSAL_Init(fsal_parameter_t * init_info);

fsal_status_t DMLITEFSAL_terminate();

fsal_status_t DMLITEFSAL_test_access(fsal_op_context_t * extcontext,
                                   fsal_accessflags_t access_type,
                                   fsal_attrib_list_t * object_attributes);
...
fsal_status_t DMLITEFSAL_rcp(fsal_handle_t * filehandle,
                           fsal_op_context_t * p_context,
...
void DMLITEFSAL_get_stats(fsal_statistics_t * stats,
...
int DMLITEFSAL_handlecmp(fsal_handle_t * exthandle1,
                       fsal_handle_t * exthandle2,
                       fsal_status_t * status);

unsigned int DMLITEFSAL_Handle_to_HashIndex(fsal_handle_t * exthandle,
                                          unsigned int cookie,
                                          unsigned int alphabet_len,
                                          unsigned int index_size);

unsigned int DMLITEFSAL_Handle_to_RBTIndex(fsal_handle_t * exthandle,
                                         unsigned int cookie);
fsal_status_t DMLITEFSAL_DigestHandle(fsal_export_context_t *extexport,
                                    fsal_digesttype_t output_type,
                                    fsal_handle_t *exthandle,
                                    struct fsal_handle_desc *fh_desc);
fsal_status_t DMLITEFSAL_ExpandHandle(fsal_export_context_t *extexport,
                                    fsal_digesttype_t in_type,
                                    struct fsal_handle_desc *fh_desc);

fsal_status_t DMLITEFSAL_SetDefault_FSAL_parameter(fsal_parameter_t * out_parameter);

fsal_status_t DMLITEFSAL_SetDefault_FS_common_parameter(fsal_parameter_t * out_parameter);

fsal_status_t DMLITEFSAL_SetDefault_FS_specific_parameter(fsal_parameter_t * out_parameter);

fsal_status_t DMLITEFSAL_load_FSAL_parameter_from_conf(config_file_t in_config,
                                                     fsal_parameter_t * out_parameter);

fsal_status_t DMLITEFSAL_load_FS_common_parameter_from_conf(config_file_t in_config,
                                                          fsal_parameter_t * out_parameter);

fsal_status_t DMLITEFSAL_load_FS_specific_parameter_from_conf(config_file_t in_config,
                                                            fsal_parameter_t * out_parameter);

fsal_status_t DMLITEFSAL_truncate(fsal_handle_t * exthandle,
                                fsal_op_context_t * extcontext,
                                fsal_size_t length,
                                fsal_file_t * file_descriptor,
                                fsal_attrib_list_t * object_attributes);

fsal_status_t DMLITEFSAL_unlink(fsal_handle_t * extparent,
                              fsal_name_t * name,
                              fsal_op_context_t * extcontext,
                              fsal_attrib_list_t * parentdir_attributes);

fsal_status_t DMLITEFSAL_GetXAttrAttrs(fsal_handle_t * exthandle,
                                     fsal_op_context_t * extcontext,
                                     unsigned int xattr_id,
                                     fsal_attrib_list_t * attrs);

fsal_status_t DMLITEFSAL_ListXAttrs(fsal_handle_t * exthandle,
                                  unsigned int cookie,
                                  fsal_op_context_t * extcontext,
...
fsal_status_t DMLITEFSAL_GetXAttrValueById(fsal_handle_t * exthandle,
                                         unsigned int xattr_id,
                                         fsal_op_context_t * extcontext,
                                         caddr_t buffer_addr,
                                         size_t buffer_size,
...
fsal_status_t DMLITEFSAL_GetXAttrIdByName(fsal_handle_t * exthandle,
                                        const fsal_name_t * xattr_name,
                                        fsal_op_context_t * extcontext,
                                        unsigned int *pxattr_id);

fsal_status_t DMLITEFSAL_GetXAttrValueByName(fsal_handle_t * exthandle,
                                           const fsal_name_t * xattr_name,
                                           fsal_op_context_t * extcontext,
                                           caddr_t buffer_addr,
                                           size_t buffer_size,
...
fsal_status_t DMLITEFSAL_SetXAttrValue(fsal_handle_t * exthandle,
                                     const fsal_name_t * xattr_name,
                                     fsal_op_context_t * extcontext,
                                     caddr_t buffer_addr,
                                     size_t buffer_size,
...
fsal_status_t DMLITEFSAL_SetXAttrValueById(fsal_handle_t * exthandle,
                                         unsigned int xattr_id,
                                         fsal_op_context_t * extcontext,
                                         caddr_t buffer_addr,
                                         size_t buffer_size);

fsal_status_t DMLITEFSAL_RemoveXAttrById(fsal_handle_t * exthandle,
                                       fsal_op_context_t * extcontext,
                                       unsigned int xattr_id);

fsal_status_t DMLITEFSAL_RemoveXAttrByName(fsal_handle_t * exthandle,
                                         fsal_op_context_t * extcontext,
                                         const fsal_name_t * xattr_name);


char *DMLITEFSAL_GetFSName();

fsal_status_t fsal_internal_testAccess(dmlitefsal_op_context_t* context,
                                       fsal_accessflags_t access_type,
                                       struct stat * st,
                                       fsal_attrib_list_t * object_attributes);
#ifdef _PNFS_MDS
nfsstat4 DMLITEFSAL_layoutget(fsal_handle_t *exhandle,
                            fsal_op_context_t *excontext,
                            XDR *loc_body,
                            const struct fsal_layoutget_arg *arg,
                            struct fsal_layoutget_res *res);
nfsstat4 DMLITEFSAL_layoutreturn(fsal_handle_t* handle,
                               fsal_op_context_t* context,
                               XDR *lrf_body,
                               const struct fsal_layoutreturn_arg *arg);
nfsstat4 DMLITEFSAL_layoutcommit(fsal_handle_t *handle,
                               fsal_op_context_t *context,
                               XDR *lou_body,
                               const struct fsal_layoutcommit_arg *arg,
                               struct fsal_layoutcommit_res *res);
nfsstat4 DMLITEFSAL_getdeviceinfo(fsal_op_context_t *context,
                                XDR* da_addr_body,
                                layouttype4 type,
                                const struct pnfs_deviceid *deviceid);
nfsstat4 DMLITEFSAL_getdevicelist(fsal_handle_t *handle,
                                fsal_op_context_t *context,
...
#ifdef _PNFS_DS
nfsstat4 DMLITEFSAL_DS_read(fsal_handle_t *handle,
                          fsal_op_context_t *context,
...
nfsstat4 DMLITEFSAL_DS_write(fsal_handle_t *handle,
                           fsal_op_context_t *context,
                           const stateid4 *stateid,
                           offset4 offset,
                           count4 write_length,
...
nfsstat4 DMLITEFSAL_DS_commit(fsal_handle_t *handle,
                            fsal_op_context_t *context,
                            offset4 offset,
                            count4 count,
                            verifier4 *writeverf);
