...
dmlitefs_specific_initinfo_t global_spec_info;
...
static fsal_staticfsinfo_t default_dmlite_info = {
  ...
  if(bythread_stat == NULL)
    {
      ...
      if((bythread_stat =
          gsh_alloc(sizeof(fsal_statistics_t))) == NULL)
        LogError(COMPONENT_FSAL, ERR_SYS, ERR_MALLOC, ENOMEM);
                                        ...
                                        fs_specific_initinfo_t * fs_specific_info)
{
...
#ifdef _PNFS_MDS
  default_dmlite_info.fs_layout_types.fattr4_fs_layout_types_val
    = layout_type_list;
  default_dmlite_info.fs_layout_types.fattr4_fs_layout_types_len
    = 1;
#endif /* _PNFS_MDS */

  /* setting default values. */
  global_fs_info = default_dmlite_info;

  LogDebug(COMPONENT_FSAL, "{");
  LogDebug(COMPONENT_FSAL, "  maxfilesize  = %llX    ",
           default_dmlite_info.maxfilesize);
  LogDebug(COMPONENT_FSAL, "  maxlink  = %lu   ",
           default_dmlite_info.maxlink);
  LogDebug(COMPONENT_FSAL, "  maxnamelen  = %lu  ",
           default_dmlite_info.maxnamelen);
  LogDebug(COMPONENT_FSAL, "  maxpathlen  = %lu  ",
           default_dmlite_info.maxpathlen);
  LogDebug(COMPONENT_FSAL, "  no_trunc  = %d ",
           default_dmlite_info.no_trunc);
  LogDebug(COMPONENT_FSAL, "  chown_restricted  = %d ",
           default_dmlite_info.chown_restricted);
  LogDebug(COMPONENT_FSAL, "  case_insensitive  = %d ",
           default_dmlite_info.case_insensitive);
  LogDebug(COMPONENT_FSAL, "  case_preserving  = %d ",
           default_dmlite_info.case_preserving);
  LogDebug(COMPONENT_FSAL, "  fh_expire_type  = %hu ",
           default_dmlite_info.fh_expire_type);
  LogDebug(COMPONENT_FSAL, "  link_support  = %d  ",
           default_dmlite_info.link_support);
  LogDebug(COMPONENT_FSAL, "  symlink_support  = %d  ",
           default_dmlite_info.symlink_support);
  LogDebug(COMPONENT_FSAL, "  lock_support  = %d  ",
           default_dmlite_info.lock_support);
  ...
  LogDebug(COMPONENT_FSAL, "  named_attr  = %d  ",
           default_dmlite_info.named_attr);
  LogDebug(COMPONENT_FSAL, "  unique_handles  = %d  ",
           default_dmlite_info.unique_handles);
  LogDebug(COMPONENT_FSAL, "  acl_support  = %hu  ",
           default_dmlite_info.acl_support);
  LogDebug(COMPONENT_FSAL, "  cansettime  = %d  ",
           default_dmlite_info.cansettime);
  LogDebug(COMPONENT_FSAL, "  homogenous  = %d  ",
           default_dmlite_info.homogenous);
  LogDebug(COMPONENT_FSAL, "  supported_attrs  = %llX  ",
           default_dmlite_info.supported_attrs);
  LogDebug(COMPONENT_FSAL, "  maxread  = %llX     ",
           default_dmlite_info.maxread);
  LogDebug(COMPONENT_FSAL, "  maxwrite  = %llX     ",
           default_dmlite_info.maxwrite);
  LogDebug(COMPONENT_FSAL, "  umask  = %X ", default_dmlite_info.umask);
  LogDebug(COMPONENT_FSAL, "}");
