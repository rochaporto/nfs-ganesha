                              ...
                              fsal_attrib_list_t * object_attributes)
{
  ...
  memset(object_handle, 0, sizeof(dmlitefsal_handle_t));
                            ...
                            fsal_attrib_list_t * attributes)
{
  ...
  struct stat st;
  char strname[FSAL_MAX_NAME_LEN];
  dmlitefsal_handle_t* target = (dmlitefsal_handle_t*) exttarget;
  dmlitefsal_handle_t* dir = (dmlitefsal_handle_t*) extdir;
  dmlitefsal_op_context_t* context = (dmlitefsal_op_context_t*) context;
  int uid = FSAL_OP_CONTEXT_TO_UID(context);
  int gid = FSAL_OP_CONTEXT_TO_GID(context);
  ...
  memset(target, 0, sizeof(dmlitefsal_handle_t));
